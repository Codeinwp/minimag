<div id="cwp_container" style="display:none">
	...
	<?php settings_fields( cwp_config("menu_slug")); ?>
		...
		<div id="header">
			...
			<a href="http://themeisle.com/forums/forum/minimag" class="button button_top" target="_blank"><?php _e('Forum','cwp'); ?></a>
			<a href="http://themeisle.com/documentation-minimag" class="button button_top" target="_blank"><?php _e('Documentation','cwp'); ?></a>
			<div class="clear"></div>
    	</div>
